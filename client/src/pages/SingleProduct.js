...
const SingleProduct = () => {
  ...
  return (
    <>
      ...
      <div className="main-product-wrapper py-5 home-wrapper-2 px-4">
              ...
              <div className="main-product-details">
                ...
                <div className="border-bottom py-3">
                  ...
                  <div className="d-flex align-items-center gap-15 my-2">
                    ...
                    <div>
                      <a href="">
                        <AiOutlineHeart className="fs-5 me-2 mb-1" /> Agregar a
                        la lista de deseos
                      </a>
                    </div>
                  </div>
                ...
                <div className="reviews mt-4">
                  <div className="review">
                    ...
                    <p className="mt-3">
                      ...
                      animi fugit distinctio ducimus odit atque necessitatibus
                      at quibusdam expedita nesciunt? Qui voluptatum incidunt
                      impedit aliquid!
                    </p>
                  </div>
                </div>
      ...
      <section className="popular-wrapper home-wrapper-2 pb-5">
        <div className="container-xxl px-4">
          <div className="row">
            <div className="col-12 ">
